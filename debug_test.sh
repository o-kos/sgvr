...
echo "Compiling test..."
rustc --edition 2021 --extern symphonia_core=/home/xokc/.cargo/registry/src/*/symphonia-core-*/src/lib.rs --extern symphonia_format_riff=/home/xokc/.cargo/registry/src/*/symphonia-format-riff-*/src/lib.rs --extern symphonia_codec_pcm=/home/xokc/.cargo/registry/src/*/symphonia-codec-pcm-*/src/lib.rs test_debug.rs -L target/debug/deps --extern symphonia=target/debug/deps/libsymphonia_core-*.rlib 2>/dev/null || {
    echo "Direct compilation failed, trying cargo..."
    echo 'name = "test_debug"
version = "0.1.0"
edition = "2021"

[dependencies]
symphonia = { version = "0.5", default-features = false, features = ["pcm", "ogg", "vorbis", "flac", "mp3", "aac", "mp4", "isomp4", "alac"] }' > Cargo_test.toml
    
    cargo build --manifest-path Cargo_test.toml --bin test_debug 2>/dev/null || echo "Cargo compilation also failed"
}
